...
/* Private defines -----------------------------------------------------------*/
#define MPS6050SCL_Pin GPIO_PIN_3
#define MPS6050SCL_GPIO_Port GPIOE
#define MPU6050SDA_Pin GPIO_PIN_4
#define MPU6050SDA_GPIO_Port GPIOE
#define INTER_button_Pin GPIO_PIN_13
#define INTER_button_GPIO_Port GPIOC
#define INTER_button_EXTI_IRQn EXTI15_10_IRQn
